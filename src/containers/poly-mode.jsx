...
import PolyTool from '../helper/tools/poly-tool';
import PolyModeComponent from '../components/poly-mode/poly-mode.jsx';

class PolyMode extends React.Component {
    constructor (props) {
        super(props);
        bindAll(this, [
            'activateTool',
    ...
    componentDidMount () {
        if (this.props.isPolyModeActive) {
    ...
    componentWillReceiveProps (nextProps) {
        ...
        if (nextProps.isPolyModeActive && !this.props.isPolyModeActive) {
            this.activateTool();
        } else if (!nextProps.isPolyModeActive && this.props.isPolyModeActive) {
            this.deactivateTool();
        }
    }
    shouldComponentUpdate (nextProps) { //
        return nextProps.isPolyModeActive !== this.props.isPolyModeActive;
    }
    ...
    render () {
        return (
            <PolyModeComponent
                isSelected={this.props.isPolyModeActive}
...
PolyMode.propTypes = {
    ...
    isPolyModeActive: PropTypes.bool.isRequired,
...
const mapStateToProps = state => ({
    ...
    isPolyModeActive: state.scratchPaint.mode === Modes.POLY,
...
const mapDispatchToProps = dispatch => ({
    ...
    handleMouseDown: () => {
        dispatch(changeMode(Modes.POLY));
    },
